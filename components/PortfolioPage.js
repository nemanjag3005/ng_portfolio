        ...
        <div className="w-full space-y-4 mt-20">
          ...
          <div>
            <svg
              ...
              x="0px"
              y="0px"
              class="block lg:hidden  h-20 w-20 opacity-30 transform rotate-180 ml-auto mr-auto"
            ...
            <svg
              ...
              version="1.1"
              xmlns="http://www.w3.org/2000/svg"
              class="hidden lg:block ml-48 h-48 w-64 -mb-32 -mt-8 opacity-30 z-20 relative "
            >
              <g
                id="Page-1"
                stroke="none"
