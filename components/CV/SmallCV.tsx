...
const SmallCV = (props: CVProps) => {
  ...
  return (
    <div className="p-5 bg-white text-black font-light mb-12">
        ...
        {transition(
          (style, item) =>
            item && (
              <animated.div
                style={style}
                className="relative h-28 w-28 aspect-square object-cover rounded-md mb-2"
              >
                <Image
                  alt="Nemanja"
                  src="/IMG_9334.jpeg"
      ...
      <p
        ...
        className="text-xs border-light-grey border-b-2 pb-3 mb-3"
      >
        {dictionary.intro}
      </p>
