...
const SmallCV = ({
  ...
  return (
    <div className="p-6 bg-white text-black mx-2 mb-12">
      ...
      <div className="grid grid-cols-4 gap-4">
        <div className="col-span-4 border-light-grey border-b-2 pb-3 mb-0">
          ...
          <div className="mb-1">
            ...
            <h5 className="text-xs my-1 font-semibold">
              TechStart UCalgary, Calgary | 2022 - {dictionary.present}
            </h5>
        ...
        <div className="col-span-2">
          ...
          <div className="grid grid-cols-1 gap-1">
            <div className="pad-0">
              <p className="text-xs">{dictionary.skill1}</p>
            </div>
            <div className="pad-0">
              <p className="text-xs">{dictionary.skill2}</p>
            </div>
            <div className="pad-0">
              <p className="text-xs">{dictionary.skill4}</p>
            </div>
            <div className="pad-0">
              <p className="text-xs">{dictionary.skill5}</p>
            </div>
          </div>
        </div>
        <div className="col-span-2">
