    ...
    <div className="max-w-6xl mx-auto py-6 overflow-hidden">
      <div className="w-full bg-blue-300 dark:bg-primary-dark-light mt-16 md:mt-0 lg:mt-12 text-blue-900 dark:text-primary-darker p-6 md:p-12 rounded-xl relative z-10">
        <div className="grid md:grid-cols-5 w-full">
            ...
            <div className="grid grid-cols-1 gap-2 md:flex md:space-x-3 items-center w-full">
              ...
              <div className="flex w-full items-center space-x-2 justify-center md:justify-start">
                <a target="_blank" rel="noopener noreferrer" href="#">
                  <svg
                    viewBox="0 0 24 24"
                    class="fill-current h-7 w-7 md:h-9 md:w-9 hover:fill-blue-500 dark:hover:fill-primary-dark"
                  >
                    <g>
          ...
          <div className="col-span-2 hidden md:flex">
              <img src='/IMG_1281-modified.png' className="align-middle rounded-full shadow-xl object-cover">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 text-zinc-800 dark:text-gray-50 mb-36">
          <a className="group relative" href='#'>
              ...
              <img src='/lan.png' className="rounded h-48 w-full object-cover group-hover:opacity-25">
